...
const App = () => {
  useEffect(() => {
    feather.replace(); 
    const spinner = document.querySelector('.loader-overlay');
      ...
      <main id="preview">
        <section className="app-preview container">
          <div className="app-preview-left">
            <img src="./images/laptop_preview.svg" alt="App image" />
          </div>

          <div className="app-preview-right">
            <h2 className="section-title">
              Optimize your expenses for greater savings and financial security
            </h2>
            <p className="section-paragraph">
              Leave behind the hassle of spreadsheets as you embrace customizable
              budgeting. Effortlessly track and adjust your income and expenses to
              fit your needs.
            </p>
        ...
        <section className="track-your-spending container" id="track">
          <div className="track-your-spending-left">
            ...
            <p className="section-paragraph">
              Achieve your objectives through tailored budget plans, monitoring your
              earnings and expenditures daily, all at no cost.
            </p>
            <div className="get-started-line">
              <a href="./pages/Dashboard/dashboard.html" className="get-started">
                Try Now !
      ...
      <footer>
        <div className="footer-card">
          ...
          <div className="social">
            ...
            <a href="https://github.com/viniscode" target="_blank">
              <i data-feather="github" id="git"></i>
            </a>
            <a href="https://instagram.com/rodriguesvini.dev" target="_blank" id="insta">
